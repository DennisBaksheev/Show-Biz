...
namespace DBA5.Controllers
{
    public class ActorController : Controller
    {
        ...
        // POST: Actor/Create
        [HttpPost, Authorize(Roles = "Admin, Executive, Coordinator"), ValidateInput(false)]
        ...
        [Route("Actors/{id}/AddShow"), Authorize(Roles = "Admin, Executive, Coordinator")]
        ...
        [Route("Actors/{id}/AddShow"), Authorize(Roles = "Admin, Executive, Coordinator"), ValidateInput(false)]
        [HttpPost]
        ...
        [Route("actors/{id}/addcontent"), Authorize(Roles = "Admin, Executive, Coordinator")]
      ...
      public ActionResult Edit(int? id)
      {
         ...
         var editModel = new ActorEditViewModel
         {
            // Map properties from ActorWithShowInfoViewModel to ActorEditViewModel
            Id = actor.Id,
            Name = actor.Name,
      ...
      public ActionResult Edit(ActorEditViewModel model)
      {
         if (!ModelState.IsValid)
         {
            return View(model);
      ...
      public ActionResult Delete(int? id)
      {
         ...
         var deleteModel = new ActorBaseViewModel
         {
            // Map properties from ActorWithShowInfoViewModel to ActorBaseViewModel
            Id = actor.Id,
            Name = actor.Name,
            AlternateName = actor.AlternateName,
            BirthDate = actor.BirthDate,
      ...
      [HttpPost, ActionName("Delete")]
         ...
         public ActionResult DeleteConfirmed(int id)
         {
            ...
            {
               // Handle the situation where deletion is not successful
